...
{
    // create the file
    ofstream file((folder + "/result.txt").c_str());

    // add file header
    file << "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t ____________________________________" << endl;
    file << "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t|                                    |" << endl;
    file << "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t|                                    |" << endl;
    file << "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t|  File generated by NetworkBuilder  |" << endl;
    file << "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t|                                    |" << endl;
    file << "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t|____________________________________|" << endl;
    file << endl << endl;
    ...
    for(unsigned int i = 0; i< buildings.size(); i++)
    {
        ...
        if(!currentBuilding->isAdmin())
        {
            ...
            for(unsigned int j = 0; j< currentBuilding->getFloors().size(); j++)
            {
                ...
                line[2] = currentBuilding->getFloors()[j]->getNetworkAddress().toString() + "/24";
        ...
        else
        {
            ...
            for(unsigned int j = 0; j< currentBuilding->getFloors().size(); j++)
            {
                ...
                line[3] = currentBuilding->getFloors()[j]->getNetworkAddress().toString() + "/24";
    ...
    for(unsigned int i = 0; i< b2bs.size(); i++)
    {
        ...
        line[3] = Constant::doubleToString(currentB2B->getDistance());
